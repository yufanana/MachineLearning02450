...
fit_prior = True   # True: estimate prior from data. empirical

# K-fold crossvalidation
K = 10
CV = model_selection.KFold(n_splits=K,shuffle=True)

X = X[:,0:1] # using 2 letters, 7651x2 matrix
...
X = OneHotEncoder().fit_transform(X=X)      # 7651x101 sparse matrix
...
print('Ran Exercise 7.4.4')

# Using 4 letters, Output: Error rate: 20.990614174303314%

# Using 2 letters, Output: Error rate: 34.70129183091862%

...
# Visualize 5 most/least similar images
for ms in range(5):

    # 5 most similar images found
    plt.subplot(3, 5, 6+ms)
    im_id = sim_to_index[-ms-1][1]  # plot 5th most similar first

...
reps = 10       # no. of fits with diff initalizations, best result will be kept
initialization_method = 'random'    # 'random' or 'kmeans', initial value of means
# random: random initiation, kmeans: run a K-means and use the
